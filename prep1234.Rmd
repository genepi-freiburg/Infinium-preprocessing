...
\begin{description}
	...
	\item[est.minfi] the white-blood-cell estimations by minfi method based on RGsets
...
save(pcaControls, betaQN, betaQN.sex,betaQN.all,betaQN.all.3IQR, est.minfi, file=paste0(outputdir,"/",analysisfilename))
