...
source('/data/studies/00_GCKD/00_data/02_methylation/01_QC/00_DNAm-preprocessing/00_scripts/parameterfile.R')
source('/data/programs/pipelines/CPACOR-EPIC_pipeline/code/ILMN-part0-split.R')
```
