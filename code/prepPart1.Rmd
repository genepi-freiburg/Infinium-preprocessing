...
for(path in scandata){ # all files in the same path have to have identical array built - they are merged later
	...
	rm(RGset)
	 	...
	 	##Potential modified bgcorrect.illumina function:
...
# 
# 
# GreenMatrix_new <- assay(rgSet, "Green")
# GreenMatrix_old <- assay(RGset, "Green")
# 
# RedMatrix_new <- assay(rgSet, "Red")
# RedMatrix_old <- assay(RGset, "Red")
# 
# print(RedMatrix)
...
#----------
	...
	#problem
# 	head(TypeII.Red_pathwise[[1]])
#            202073180065_R05C01 202073200086_R06C01 205537620061_R06C01 205537620061_R07C01
# cg07881041                 740                1144                 395                 161
# cg23229610                 175                 320                 118                  53
# cg03513874                 327                 466                 237                 161
# 
# head(TypeII.Red_pathwise[[2]])
#                 207810890008_R01C01 207810890120_R01C01 207831660084_R01C01 207810890008_R02C01
# cg25335775_BC21                8053                8947                8347                8136
# cg25341653_BC21                1526                1758                1966                1214
# cg25372195_BC21                1462                1444                2518                1305
# v1<-rownames(TypeII.Red_pathwise[[1]])
# v2<-rownames(TypeII.Red_pathwise[[2]])
# v2_2<-sub("_.*", "", v2)	
# length(intersect(v1,v2_2)) #612824
}
