...
samplesinclude <- intersect(names(sample.call),paste(datsamples$Sentrix_ID,datsamples$Sentrix_Position,sep = "_"))
...
if(length(samplesinclude)<101){
	...
	datsamples$Sample_Name[paste(datsamples$Sentrix_ID,datsamples$Sentrix_Position,sep = "_")%in%samplesinclude]
}
```
