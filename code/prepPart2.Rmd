...
removeOutlier <- function(val1,val2,labels=NULL,xname="val1",yname="val2",title="",filterYout=1, SDrange=4 ,nullOffs=0.0001 ) {
	...
	# Add dashed line at ryup
	if (filterYout!=2) {segments(rxleft, ryup, rxright + 2, ryup, lty = "dashed", col = "grey")}
...
```{r, echo=FALSE}
knitr::include_graphics("BS_I_C_U_red.pdf")
knitr::include_graphics("BS_I_C_U_green.pdf")
knitr::include_graphics("BS_II_red_vs_green.pdf")
```
...
pdf("Staining_red_Upper_left_cluster.pdf")
...
dev.off()
pdf("Staining_Red_cross_check_with_Extension_outliers.pdf")
...
pdf("Staining_green_Upper_left_cluster.pdf")
...
pdf("cross_check_with_Extension_outliers.pdf")
...
```{r, echo=FALSE}
knitr::include_graphics("Hybridization_green.pdf")
knitr::include_graphics("Specificity_I_red.pdf")
knitr::include_graphics("Specificity_I_green.pdf")
knitr::include_graphics("Specificity_II.pdf")
knitr::include_graphics("Extensions.pdf")
knitr::include_graphics("Staining_red_Upper_left_cluster.pdf")
#knitr::include_graphics("Staining_Red_cross_check_with_Extension_outliers.pdf")
knitr::include_graphics("Staining_green_Upper_left_cluster.pdf")
knitr::include_graphics("Staining_red_vs_green.pdf")
knitr::include_graphics("cross_check_with_Extension_outliers.pdf")
```
...
if (file.exists("find_female_outlier.pdf")) {
  knitr::include_graphics("find_female_outlier.pdf")
}
if (file.exists("find_male_outlier.pdf")) {
  knitr::include_graphics("find_male_outlier.pdf")
}
if (file.exists("find_female_outlier_2.pdf")) {
  knitr::include_graphics("find_female_outlier_2.pdf")
}
if (file.exists("find_male_outlier_2.pdf")) {
  knitr::include_graphics("find_male_outlier_2.pdf")
}
```
...
if(min(dim(na.omit(betaPCA))) > 0){
	...
	# plot first males, then females: find female outlier
	idx = which(EV$Sex_female%in%c(1)) # 1 is female
	pdf("PCA_find_female_outlier.pdf")
	...
	if(min(dim(na.omit(betaPCA))) > 0){
		...
		# plot first males, then females: find female outlier
		idx = which(EV$Sex_female%in%c(1)) # 1 is female
		pdf("PCA_find_female_outlier_2.pdf")
		plot(EV[-idx,"PC1"],EV[-idx,"PC2"],col="orange", main=paste0("number of sex probes: ",nrow(betaPCA)," (RAW NA omitted)"),sub = "check for female outlier", xlab=paste0("PC1 (",sprintf("%1.1f",(pcaSex$sdev^2/sum(pcaSex$sdev^2))[1]*100),"%)"),ylab=paste0("PC2 (",sprintf("%1.1f",(pcaSex$sdev^2/sum(pcaSex$sdev^2))[2]*100),"%)"), xlim = c(min(EV[,"PC1"]),max(EV[,"PC1"])+ 0.25*( max(EV[,"PC1"]) - min(EV[,"PC1"])  )), ylim = c(min(EV[,"PC2"]),max(EV[,"PC2"]) ))
		points(EV[idx,"PC1"],EV[idx,"PC2"],col="blue")
		legend("top", pch = c(1,1), col = c("blue","orange"), legend = c("women","men"))
		dev.off()
		...
		# then plot first females, then males: find male-outlier
		pdf("PCA_find_male_outlier_2.pdf")
		plot(EV[idx,"PC1"],EV[idx,"PC2"],col="blue", main=paste0("number of sex probes: ",nrow(betaPCA)," (RAW NA omitted)"),sub = "check for male outlier", xlab=paste0("PC1 (",sprintf("%1.1f",(pcaSex$sdev^2/sum(pcaSex$sdev^2))[1]*100),"%)"),ylab=paste0("PC2 (",sprintf("%1.1f",(pcaSex$sdev^2/sum(pcaSex$sdev^2))[2]*100),"%)"), xlim = c(min(EV[,"PC1"]),max(EV[,"PC1"])+ 0.25*(max(EV[,"PC1"]) - min(EV[,"PC1"])  )), ylim = c(min(EV[,"PC2"]),max(EV[,"PC2"]) ))
		points(EV[-idx,"PC1"],EV[-idx,"PC2"],col="orange")
		legend("top", pch = c(1,1), col = c("blue","orange"), legend = c("women","men"))
...
if (file.exists("PCA_find_female_outlier.pdf")) {
  knitr::include_graphics("PCA_find_female_outlier.pdf")
}
if (file.exists("PCA_find_male_outlier.pdf")) {
  knitr::include_graphics("PCA_find_male_outlier.pdf")
}
if (file.exists("PCA_find_female_outlier_2.pdf")) {
  knitr::include_graphics("PCA_find_female_outlier_2.pdf")
}
if (file.exists("PCA_find_male_outlier_2.pdf")) {
    knitr::include_graphics("PCA_find_male_outlier_2.pdf")
}
```
...
if(length(sex.mismatches) > 0 & all(!is.na(sex.mismatches))){
	print(sex.mismatches)
