...
# parameters
sex.mismatch.callrate.minimum <- 0.0001 # in case there are too many missing sex probes # this is basically representing a callrate minimum of zero 
...
if(min(dim(na.omit(betaPCA))) > 0){ # otherwise code would crash if all cg sites have missings
	...
	# exclude samples with sex cpg site callrate lower or equal than minimum callrate
	...
	# transfer this to part 3 typewise callrate (better would be a function ^^)
