...
pcaControls <- EV # to have merged version
...
The next PCA will be conducted on autosomal beta values after quantile normalisation and the PCA is per variable.   
...
Next we will plot the corresponding principal components of samples coloured by batches (autosomal beta after QN). 
...
```
Simple plots with colouring by Sample Plate:
```{r} 
 qplot(EV[,"PC1"],EV[,"PC2"], main=paste0("number of autosomal probes: ",nrow(pcaAuto$x),"\n color by Sample_Plate"),xlab=paste0("EV1 (",sprintf("%1.1f",(pcaAuto$sdev^2/sum(pcaAuto$sdev^2))[1]*100),"%)"),ylab=paste0("EV2 (",sprintf("%1.1f",(pcaAuto$sdev^2/sum(pcaAuto$sdev^2))[2]*100),"%)"), colour = EV$Sample_Plate)
 qplot(EV[,"PC3"],EV[,"PC4"], main=paste0("number of autosomal probes: ",nrow(pcaAuto$x),"\n color by Sample_Plate"),xlab=paste0("EV3 (",sprintf("%1.1f",(pcaAuto$sdev^2/sum(pcaAuto$sdev^2))[3]*100),"%)"),ylab=paste0("EV4 (",sprintf("%1.1f",(pcaAuto$sdev^2/sum(pcaAuto$sdev^2))[4]*100),"%)"), colour = EV$Sample_Plate)
