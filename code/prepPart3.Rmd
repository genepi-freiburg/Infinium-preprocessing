...
```{r} 
PC <- EV
 qplot(PC[,"PC1"],PC[,"PC2"], main=paste0("number of samples: ",nrow(pcaSamples$x),"\n color by Sample_Plate"),xlab=paste0("PC1 (",sprintf("%1.1f",(pcaAuto$sdev^2/sum(pcaAuto$sdev^2))[1]*100),"%)"),ylab=paste0("PC2 (",sprintf("%1.1f",(pcaAuto$sdev^2/sum(pcaAuto$sdev^2))[2]*100),"%)"), colour = PC$Sample_Plate)
 qplot(PC[,"PC3"],PC[,"PC4"], main=paste0("number of samples: ",nrow(pcaSamples$x),"\n color by Sample_Plate"),xlab=paste0("PC3 (",sprintf("%1.1f",(pcaAuto$sdev^2/sum(pcaAuto$sdev^2))[3]*100),"%)"),ylab=paste0("PC4 (",sprintf("%1.1f",(pcaAuto$sdev^2/sum(pcaAuto$sdev^2))[4]*100),"%)"), colour = PC$Sample_Plate)
