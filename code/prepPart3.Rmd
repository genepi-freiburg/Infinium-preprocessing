...
`r nrow(datsamples)` samples are included in the analysis, identified by the *samplesfilefinal* and existing sample calls.
...
Additionally we supply the Sentrix_IDs of outliers (defined by three times the standard deviation per PC). They are exported to the file `r paste0("samples-with-batch-effect","_",projectname,"-",formatted.time,".csv")`.
```{r}
