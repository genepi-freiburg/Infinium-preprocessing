...
`r nrow(datsamples)` samples are included in the analysis, identified by the *samplesfilefinal*, existing sample calls and samplewise minimum callrate `r minimum_callrate`. Callrate filtering is performed on autosomes and for sex chromosome QN additionally on sex chromosomes.
