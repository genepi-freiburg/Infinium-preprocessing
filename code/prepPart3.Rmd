...
# report QN sample filter to samples.filtered
	...
	QN.filter.df = data.frame(sample = bufout.callrate.typewise.auto, filter = paste0("for Quantile Normalisation: callrate.typewise.autosomes < ", 1 - minimum_callrate_QN), stringsAsFactors= F)
