...
# report QN sample filter to samples.filtered
	QN.filter.df = data.frame(sample = bufout.callrate.typewise.auto, filter = paste0(c("for Quantile Normalisation: callrate.typewise.autosomes < ", (1 - minimum_callrate_QN)), stringsAsFactors= F)
...
# report QN sample filter to samples.filtered
	QN.filter.sex.df = data.frame(sample = bufout.callrate.typewise.auto, filter = paste0(c("for Quantile Normalisation: callrate.typewise.sexchromosomes < ", (1 - minimum_callrate_QN)), stringsAsFactors= F)
